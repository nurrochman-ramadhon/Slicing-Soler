...
export default function Section1() {
  return (
    <div className="flex flex-col-reverse md:flex-row justify-between lg:pl-[80px] pl-4">
      <div className="mt-[44px]">
        {/* Main Description */}
        <div className="md:w-[300px] lg:w-[600px] flex flex-col gap-[24px]">
      ...
      <div className="flex justify-end">
        <Image src={banner1} alt="banner 1" className="w-[312px] md:w-[834px]" />
      </div>

      {/* vector bg for banner image and through navbar */}
      <div className="absolute -z-10 -right-[48px] -top-[40px] md:-top-[79px] md:-right-[69px]">
